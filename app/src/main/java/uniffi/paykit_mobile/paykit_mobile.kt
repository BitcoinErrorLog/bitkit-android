...
open class DirectoryOperationsAsync : Disposable, AutoCloseable, DirectoryOperationsAsyncInterface {
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `removePaymentEndpoint`(
        `transport`: AuthenticatedTransportFfi,
        `methodId`: kotlin.String
    ) =
        callWithPointer {
...
open class PaykitClient : Disposable, AutoCloseable, PaykitClientInterface {
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `createNoiseErrorMessage`(
        `code`: kotlin.String,
            ...
            callWithPointer {
                uniffiRustCallWithError(PaykitMobileException) { _status ->
                    UniffiLib.INSTANCE.uniffi_paykit_mobile_fn_method_paykitclient_create_payment_request(
                        ...
                        FfiConverterString.lower(`description`), FfiConverterOptionalULong.lower(`expiresInSecs`), _status
                    )
                }
            }
        )
            ...
            callWithPointer {
                uniffiRustCallWithError(PaykitMobileException) { _status ->
                    UniffiLib.INSTANCE.uniffi_paykit_mobile_fn_method_paykitclient_create_receipt_confirmation_message(
                        ...
                        FfiConverterOptionalString.lower(`currency`), FfiConverterOptionalString.lower(`signature`), _status
                    )
                }
            }
        )
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `parseNoisePaymentMessage`(
        `json`: kotlin.String
    ): NoisePaymentMessage {
        return FfiConverterTypeNoisePaymentMessage.lift(
            callWithPointer {
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `parseReceiptMetadata`(
        `metadataJson`: kotlin.String
    ): kotlin.String {
        return FfiConverterString.lift(
            callWithPointer {
...
open class PaykitInteractiveManagerFfi : Disposable, AutoCloseable, PaykitInteractiveManagerFfiInterface {
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `createEndpointOffer`(
        `methodId`: kotlin.String,
        `endpoint`: kotlin.String
    ): kotlin.String {
        return FfiConverterString.lift(
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `getPrivateEndpoint`(
        `peer`: kotlin.String,
        `methodId`: kotlin.String
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `listPrivateEndpoints`(
        `peer`: kotlin.String
    ): List<PrivateEndpointOffer> {
...
open class ReceiptStore : Disposable, AutoCloseable, ReceiptStoreInterface {
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `savePrivateEndpoint`(
        `peer`: kotlin.String,
...
open class SpendingManagerFfi : Disposable, AutoCloseable, SpendingManagerFfiInterface {
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `getPeerSpendingLimit`(
        `peerPubkey`: kotlin.String
    ): PeerSpendingLimitFfi? {
     ...
     */
    @Throws(PaykitMobileException::class)
    override fun `tryReserveSpending`(
        `peerPubkey`: kotlin.String,
        `amountSats`: kotlin.Long
    ): SpendingReservationFfi {
...
open class UnauthenticatedTransportFfi : Disposable, AutoCloseable, UnauthenticatedTransportFfiInterface {
    ...
    companion object {
         ...
         */
        @Throws(PaykitMobileException::class)
        fun `fromAuthenticated`(
            `auth`: AuthenticatedTransportFfi
 ...
 */
@Throws(PaykitMobileException::class)
fun `createExecutorAsyncBridgeWithTimeout`(
    `timeoutMs`: kotlin.ULong
): ExecutorAsyncBridge {
    return FfiConverterTypeExecutorAsyncBridge.lift(
        uniffiRustCallWithError(PaykitMobileException) { _status ->
 ...
 */
@Throws(PaykitMobileException::class)
fun `createSpendingManager`(
    `storagePath`: kotlin.String
): SpendingManagerFfi {
 ...
 */
@Throws(PaykitMobileException::class)
fun `ed25519KeypairFromSecret`(
    `secretKeyHex`: kotlin.String
): Ed25519Keypair {
